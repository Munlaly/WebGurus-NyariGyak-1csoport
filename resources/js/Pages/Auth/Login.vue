...
<template>
  ...
  >
    <div class="flex min-h-screen w-full flex-col md:flex-row">
      ...
      <main
        class="bg-surface-container-low z-10 flex w-full shrink-0 grow flex-col justify-center px-6 py-10 shadow-[0px_4px_20px_rgba(0,0,0,0.04)] md:w-1/2 md:px-16 lg:w-125"
      >
